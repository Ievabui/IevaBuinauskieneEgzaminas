...
/* harmony import */ var _modules_searchFilm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/searchFilm */ "./src/modules/searchFilm.js");


(0,_modules_renderForm__WEBPACK_IMPORTED_MODULE_0__["default"])();
(0,_modules_searchFilm__WEBPACK_IMPORTED_MODULE_1__["default"])();
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var createPoster = function createPoster(response) {
  if (response !== "N/A") {
    var elementPoster = document.createElement('div');
    elementPoster.className = 'col-12 col-lg-12 col-md-12 col-sm-3 col-xs-2';
    elementPoster.innerHTML += "<div><img class=\"img-thumbnail\" src=\"".concat(response, "\" alt=\"poster\"/>\n</div>");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (createPoster);
...
var createText = function createText(response) {
  ...
  elementText.innerHTML += "<div><p>".concat(response, "</p></div>");
...
var form = function form() {
  return "<div class=\"form-group mb-2 box-shadow\">\n<input type=\"text\" class=\"form-control term\" placeholder=\"Filmo pavadinimas\">\n</div>\n<button type=\"submit\" class=\"btn btn-success\">Paie\u0161ka</button>\n    ";
};
...
/* harmony import */ var _createPoster__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createPoster */ "./src/modules/createPoster.js");
/* harmony import */ var _createText__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./createText */ "./src/modules/createText.js");
  ...
  document.querySelector('form').addEventListener('submit', function (e) {
    ...
    (0,_ajaxService__WEBPACK_IMPORTED_MODULE_0__["default"])(searchTerm).then(function (result) {
      ...
      if (searchResponse.Response !== 'False') {
        ...
        (0,_createPoster__WEBPACK_IMPORTED_MODULE_1__["default"])(searchResponse.Poster);
        (0,_createText__WEBPACK_IMPORTED_MODULE_2__["default"])("Filmo pavadinimas: " + searchResponse.Title);
        (0,_createText__WEBPACK_IMPORTED_MODULE_2__["default"])("Filmo trukmė: " + searchResponse.Runtime);
        (0,_createText__WEBPACK_IMPORTED_MODULE_2__["default"])("Režisierius: " + searchResponse.Director);
        (0,_createText__WEBPACK_IMPORTED_MODULE_2__["default"])("Aktoriai: " + searchResponse.Actors);
        (0,_createText__WEBPACK_IMPORTED_MODULE_2__["default"])("IMDb reitingas: " + searchResponse.imdbRating);
      } else {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (searchFilm);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkievabuinauskieneegzaminas"] = self["webpackChunkievabuinauskieneegzaminas"] || [];
